...
import 'package:food_menu/upload/salad_upload.dart';

class Salad_Page extends StatefulWidget {
  const Salad_Page({super.key});

  @override
  State<Salad_Page> createState() => _Salad_PageState();
}
...
class _Salad_PageState extends State<Salad_Page> {
  ...
  _apiPostList() async {
    var list = await RTDBService.getSalads();
    items2.clear();
    setState(() {
      items2 = list;
    });
                        ...
                        Row(
                          children: [
                            Container(
                              ...
                              child: items2[index].img_url != null
                                  ? Container(
                                decoration: BoxDecoration(
                                    borderRadius: BorderRadius.circular(20),
                                    image: DecorationImage(
                                      image: NetworkImage(items2[index].img_url!), fit: BoxFit.cover,
                                    )
                                ),
                              )
                                  : Container(
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 2,),
                                Text(
                                  "Narxi:${items2[index].caption!}so'm",
                                  style: TextStyle(
                                      color: Colors.white,
                                ...
                                TextButton(
                                  onPressed: () {
                                    _showFullTextDialog(context, items2[index].caption1!);
                                  },
                                  child: Text(
                                    "To'liq ko'rish",
                          ...
                          child: InkWell(
                            onTap: () async {
                              try {
                                ...
                                await RTDBService.deleteSalad(items2[index].id!);
