...
import 'package:food_menu/upload/sweet_upload.dart';
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 2,),
                                Text(
                                  "Narxi:${items2[index].caption!}",style: TextStyle(color: Colors.white,fontWeight: FontWeight.w500,fontSize: 15),),
                                Container(
                          ...
                          child: InkWell(
                            onTap: () async {
                              try {
                                ...
                                await RTDBService.deleteSweet(items2[index].id!);
