...
import 'package:food_menu/upload/food_upload.dart';
                        ...
                        Row(
                          children: [
                            Container(
                              ...
                              child: items1[index].img_url != null
                                  ? Container(
                                decoration: BoxDecoration(
                                    borderRadius: BorderRadius.circular(20),
                                    image: DecorationImage(
                                      image: NetworkImage(items1[index].img_url!), fit: BoxFit.cover,
                                    )
                                ),
                              )
                                  : Container(
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 2,),
                                Text(
                                  "Narxi:${items1[index].caption!}so'm",
                                  style: TextStyle(
                                      color: Colors.white,
                                ...
                                TextButton(
                                  onPressed: () {
                                    _showFullTextDialog(context, items1[index].caption1!);
                                  },
                                  child: Text(
                                    "To'liq ko'rish",
                          ...
                          child: InkWell(
                            onTap: kIsWeb
                              ...
                              try {
                                ...
                                await RTDBService.deleteFood(items1[index].id!);
                                ...
                                ScaffoldMessenger.of(context)
                                    .showSnackBar(
                                  SnackBar(
                                      content: Text('Postni o\'chirishda xato yuz berdi: $e')),
                                );
                              }
                            },
                            child: kIsWeb
