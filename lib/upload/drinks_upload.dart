...
class _UploadIchimliklarState extends State<UploadIchimliklar> {
  ...
  _apiUploadImage(String name, String content,String caption1) {
    ...
    StorageService.uploadImage(_image!).then((img_url) => {
      _apiCreateIchimliklar(name, content, img_url,caption1),
    });
  }

  _apiCreateIchimliklar(String name, String content, String img_url,String caption1) {
    var post = Post(name: name, caption: content, img_url: img_url, caption1:caption1);
    RTDBService.addDrink(post).then((value) => {
      _resAddPost(),
    });
  }
